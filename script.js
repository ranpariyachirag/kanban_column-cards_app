...
class todoList{
    constructor(place, title = "Column 1"){
    ...
    createToDoListElement(){
        ...
        this.button.innerText = 'Add Card';
        ...
        this.deletecolumnbtn.classList.add("btn-delete");
        this.deletecolumnbtn.innerText = "Delete Column";
        this.deletecolumnbtn.addEventListener('click', ()=>{
            this.deleteColumn.call(this);
        });
        ...
        this.todoListElement.append(this.deletecolumnbtn);
...
// delete column function
    deleteColumn(){
        ...
        let j = this.todoListElement.cardArray.indexOf(this);
        this.todoListElement.cardArray.splice(j,1);
    }

    // end delete column function
}
...
class Card{
    constructor(text, place, todoList){
        ...
        this.state = {
            text: text,
            description: "click here to add card discription",
            comments: []
        }
        this.render();
    }
    ...
    showMenu(){
        ...
        this.commentsButton.className = "commentsButton btn-add";

        //Add inner Text
        this.commentsButton.innerText = "Add Comments";
        this.commentsInput.placeholder = "Write a comment here...";
        ...
        wrapper.append(this.menuContainer);
...
class EditableText{
    ...
    showEditableTextArea(){
        ...
        this.saveButton.className = "btn-add";
        this.input.classList.add("comment");
...
let todoList1 = new todoList(wrapper);
